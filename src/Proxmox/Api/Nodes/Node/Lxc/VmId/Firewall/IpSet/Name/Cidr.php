...
namespace Proxmox\Api\Nodes\Node\Lxc\VmId\Firewall\IpSet\Name;
...
class Cidr extends PVEPathClassBase
{
     ...
     * @link https://pve.proxmox.com/pve-docs/api-viewer/#/nodes/{node}/lxc/{vmid}/firewall/aliases/{name}/{cidr}
     * @return array|null
     */
